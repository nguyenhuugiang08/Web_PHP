    ...
    <div class="main">
        <nav class="nav-category">
            ...
            <ul class="control-list">
                ...
                <li class="control-list__item">
                    <a href="../statistical/statistical.php" class="control-list__item-link">
        ...
        <div class="content">
            <div class="header">
                <!-- <a href="../home/index.php" style="text-decoration:none;">
                    <h4 class="d-flex justify-content-center align-items-center" style="color: #fff; margin-left: 220px;">
