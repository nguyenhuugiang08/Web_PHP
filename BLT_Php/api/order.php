...
?>
            ...
            <?php
                    echo '
                        ...
                        ' . ($item['status'] == 0 ? "<div class ='action-cancel me-3' onclick = 'cancelOrder(" . $item['order_id'] . ")'>Hủy Đơn</div>" : ($item['status'] == 1 ? "<div class ='action-cancel me-3' onclick = 'cancelOrder(" . $item['order_id'] . ")'>Hủy Đơn</div>" : ($item['status'] == 2 ? "<div class ='action-confirm' onclick = 'confirmOrder(" . $item['order_id'] . ")'>Xác Nhận Nhận Hàng</div>" : ($item['status'] == 3 ? "<a href = 'product_details.php?id= " . $item['id'] . "' class ='action-rebuy me-3'>Mua Lại</a>" :
