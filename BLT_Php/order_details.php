...
where orders.id = order_details.order_id and order_details.product_id = product.id and user_id = $id ";
...
<div class="wrapper-order__details">
    <div class="container order-details-main">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="row">
                    <div class="col-md-3 filter-order filter-order--active">Tất cả</div>
                    <div class="col-md-3 filter-order">Chờ xác nhận</div>
                    <div class="col-md-3 filter-order">Đã giao</div>
                    <div class="col-md-3 filter-order">Đã hủy</div>
                    <div class="col-md-12">
                        <?php
                        foreach ($result as $item) {
                            echo '
                                <div class="row order__details-items">
                                    ...
                                    ' . ($item['status'] == 0 ? "CHỜ XÁC NHẬN" : ($item['status'] == 1 ? "ĐÃ HỦY" : "ĐÃ GIAO")) . '
                                    </div>
